...
insula::graphics::camera::cli_options()
{
	...
	opts.add_options()
		("camera-movement-speed",boost::program_options::value<scalar>(),"Rolling speed of the camera")
		("camera-rotation-speed",boost::program_options::value<scalar>(),"Speed of the camera")
