...
*** TODO Wasseroberfläche
*** TODO Bug in Wassertextur fixen
*** TODO Optimierung
gl_FragCoord nehmen statt die Texturkoordinate mit der anderen Modelview-Matrix auszurechnen?
** TODO Nebel 
...
gl_FragColor = mix(gl_Fog.color, finalColor, fogFactor ); Nebel
#+END_SRC

Oder doch lieber im Vertexshader, siehe [[http://www.ozone3d.net/tutorials/glsl_fog/p03.php][hier]].
