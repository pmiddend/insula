...
** height_field::random_flat_point()
...
** physics::vehicle::object muss den Userpointer auf this setzen
Außerdem muss es von object ableiten.
** physics::vehicle::model brauch ein "disabled"-Flag
...
** physics::world: In der World wird ein neues Signal benötigt, was
...
** machine:
  ...
  "sounds -> nonstreaming") zu Soundpuffern umsetzt. 
	...
	Die Maschine enthält auch den Soundpool. Am besten kulminiert das ganze in zwei Funktionen:
