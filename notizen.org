...
Debuggen, Möglichkeiten:

- bullet updaten
- Debugdrawer implementieren, gucken ob die Shapes die falsche Größe
  haben oder kollidieren wo sie es nicht sollen
- btHeightfieldTerrainShape durch btBvhTriangleShape ersetzen
- btRaycastVehicle genauer angucken, schauen wie es funzt
